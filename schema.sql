...
CREATE TABLE collection (collection_id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, author_id INT NOT NULL, posted TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, title VARCHAR(255) NOT NULL, meta JSON, members JSON, FOREIGN_KEY (author_id) REFERENCES user (user_id));
